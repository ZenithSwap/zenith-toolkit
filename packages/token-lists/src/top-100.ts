...
/**
 * Fetch Top100 Tokens traded on ZenithSwap v2, ordered by trading volume,
...
const main = async (): Promise<void> => {
  try {
    ...
    const tokenListPath = `${path.resolve()}/src/tokens/zenithswap-top-100.json`;
