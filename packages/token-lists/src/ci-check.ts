import srcDefault from "./tokens/zenithswap-default.json";
import srcExtended from "./tokens/zenithswap-extended.json";
import srcTop100 from "./tokens/zenithswap-top-100.json";
import srcTop15 from "./tokens/zenithswap-top-15.json";
import defaultList from "../lists/zenithswap-default.json";
import extendedtList from "../lists/zenithswap-extended.json";
import top15List from "../lists/zenithswap-top-15.json";
import top100tList from "../lists/zenithswap-top-100.json";
