...
const Nfts: Nft[] = [
  {
    name: "Mixie v1",
    description: "Stories were told, and songs were sung, about Chef Mixie’s zeniths and her big Syrup gun.",
    images: {
      lg: "mixie-1-lg.png",
      md: "mixie-1-md.png",
      sm: "mixie-1-sm.png",
  ...
  {
    name: "Sleepy",
    description: "Aww, looks like eating zeniths all day is tough work. Sweet dreams!",
    images: {
      lg: "sleepy-lg.png",
      md: "sleepy-md.png",
      sm: "sleepy-sm.png",
  ...
  {
    name: "Swapsies",
    description: "These bunnies love nothing more than swapping zeniths. Especially on BSC.",
    images: {
      lg: "swapsies-lg.png",
      md: "swapsies-md.png",
      sm: "swapsies-sm.png",
