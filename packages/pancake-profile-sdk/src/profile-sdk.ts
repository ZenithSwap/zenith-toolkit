...
class ZenithProfileSdk {
   ...
   * API repo - https://github.com/zenithswap/zenith-profile-api
   */
   ...
   * Contract repo - https://github.com/zenithswap/zenith-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from ZenithProfile contract.
   * NFT's bunnyId is retrieved from ZenithBunnies contract and mapped to static NFT data stored in constant.
   * Contracts repo - https://github.com/zenithswap/zenith-contracts/tree/master/projects/profile-nft-gamification
   */
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://zenithswap.finance/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "zenithswap.finance", secure: true, expires: 30 }
        );
      }
