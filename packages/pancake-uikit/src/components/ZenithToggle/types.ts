...
export interface ZenithToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  zenithSize: "zenithSize",
  travelDistance: "travelDistance",
  toggleHeight: "toggleHeight",
  toggleWidth: "toggleWidth",
  zenithThickness: "zenithThickness",
  zenithTwoOffset: "zenithTwoOffset",
  zenithThreeOffset: "zenithThreeOffset",
  butterTop: "butterTop",
