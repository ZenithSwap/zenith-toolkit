/**
 * @see https://github.com/zenithswap/zenith-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  cake: {
    symbol: "CAKE",
    ...
    decimals: 18,
    projectLink: "https://zenithswap.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://zenithbunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {
